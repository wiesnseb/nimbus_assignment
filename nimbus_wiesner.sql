...
ON public.data_table.join_id = public.email_table.join_id
WHERE (
    MOD(public.data_table.column_1, 2) = 0 AND
    public.data_table.column_3 LIKE '%1' AND
    public.data_table.column_2 < public.data_table.column_1
);